...
public class SellerSignupServiceEntity {
	...
	public String toString() {
		return "SellerSignupServiceEntity [id=" + id + ", username=" + username + ", password=" + password
				+ ", company=" + company + ", brief=" + brief + ", gst=" + gst + ", address=" + address + ", email="
				+ email + ", website=" + website + ", contact=" + contact + "]";
	}
